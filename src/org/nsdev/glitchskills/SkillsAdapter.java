...
public class SkillsAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            int timeRemaining = o.getInt("time_remaining");
            int totalTime = o.getInt("total_time");

            if (timeRemaining != 0) {
                int complete = totalTime - timeRemaining;
                holder.progress.setVisibility(View.VISIBLE);
                
                holder.progress.setMax(totalTime);
                holder.progress.setProgress(complete);
                
                holder.timeToLearn.setVisibility(View.VISIBLE);
                holder.timeToLearnLabel.setVisibility(View.VISIBLE);
                
                holder.timeToLearn.setText(formatDuration(timeRemaining));
